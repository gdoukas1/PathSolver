...
class SequentialSearch(SearchBaseClass, ABC):
    ...
    def recursive_DFS(self, node_current):
        ...
        for primitive_successor in node_current.get_successors():
            ...
            if goal_flag:
                ...
                goal_found = True
                return goal_found, path_solution, count, g_cost

            # if goal is not reached, continue the search recursive
            goal_found, path_solution, count, g_cost = self.recursive_DFS(node_current=child)
    ...
    def execute_search(self, time_pause, heuristic_option, heuristic_weight):
        ...
        found_path, path_solution, count, g_cost = self.recursive_DFS(node_current=node_initial)
        return path_solution, count, 0, g_cost
